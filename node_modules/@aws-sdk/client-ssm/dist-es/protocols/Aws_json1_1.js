...
const se_ComplianceExecutionSummary = (input, context) => {
    return take(input, {
        ExecutionId: [],
        ExecutionTime: (_) => _.getTime() / 1000,
        ExecutionType: [],
    });
};
...
const se_CreateOpsItemRequest = (input, context) => {
    return take(input, {
        AccountId: [],
        ActualEndTime: (_) => _.getTime() / 1000,
        ActualStartTime: (_) => _.getTime() / 1000,
        Category: [],
        Description: [],
        Notifications: _json,
        OperationalData: _json,
        OpsItemType: [],
        PlannedEndTime: (_) => _.getTime() / 1000,
        PlannedStartTime: (_) => _.getTime() / 1000,
        Priority: [],
...
const se_StartChangeRequestExecutionRequest = (input, context) => {
    return take(input, {
        ...
        Parameters: _json,
        Runbooks: _json,
        ScheduledEndTime: (_) => _.getTime() / 1000,
