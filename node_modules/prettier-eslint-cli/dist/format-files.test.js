...
test('sanity test', async () => {
  ...
  expect(_glob.glob).toHaveBeenCalledTimes(globs.length);
...
test('glob call inclues an ignore of node_modules', async () => {
  ...
  expect(_glob.glob).toHaveBeenCalledWith(fileGlob, globOptions);
});
test('glob call excludes an ignore of node_modules', async () => {
  ...
  expect(_glob.glob).not.toHaveBeenCalledWith(expect.any, expect.objectContaining({
...
test('should accept stdin', async () => {
  ...
  expect(_prettierEslint.default).toHaveBeenCalledTimes(1);
